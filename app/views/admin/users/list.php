...
<div class="list-container">
    <div class="list-content">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="/volta/public/users/create" class="btn-submit">
                <?= Icons::add('btn-icon') ?>
                Add User
            </a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <form method="GET" action="/volta/public/users" class="flex flex-col sm:flex-row gap-4">
                <div class="flex-1">
                ...
                <div class="flex gap-2 items-end">
                    ...
                    <a href="/volta/public/users" class="btn-cancel">
                        Clear
                    </a>
                </div>
            </form>
                        ...
                        <tbody id="usersTableBody" class="bg-white divide-y divide-gray-200">
                            <?php foreach ($users as $user): ?>
                                <tr class="hover:bg-gray-50" id="user-row-<?= $user->getId() ?>">
                                    ...
                                    <td class="table-cell">
                                        <a href="/volta/public/users/edit/<?= $user->getId() ?>"
...
<script src="/volta/public/javascript/user.js"></script>
